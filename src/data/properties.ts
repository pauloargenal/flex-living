import type { PropertyData } from '@/types/review';
...
export const propertyDescriptions: Record<string, string> = {
  '2b-n1-a-29-shoreditch-heights':
    'Modern 2-bedroom apartment in the heart of trendy Shoreditch with stunning city views.',
  'luxury-suite-canary-wharf-tower':
    'Elegant suite in Canary Wharf with panoramic views and premium amenities.',
  'elegant-garden-flat-kensington':
    'Charming period property with private garden access near Kensington Gardens.',
  'industrial-loft-camden-town':
    'Unique industrial-style loft in vibrant Camden with exposed brick and high ceilings.',
  'cozy-studio-greenwich-village':
    'Perfectly formed studio apartment near Greenwich Park and the Royal Observatory.',
  'premium-penthouse-westminster':
    'Luxurious penthouse with private terrace and views of Westminster landmarks.',
  'riverside-apartment-southbank':
    'Stunning Thames-side apartment with river views near Tate Modern and Borough Market.',
  'modern-flat-kings-cross':
    'Sleek contemporary flat in regenerated Kings Cross, perfect for Eurostar travelers.',
  'victorian-townhouse-notting-hill':
    'Charming three-floor Victorian townhouse on a picturesque Notting Hill street.',
  'art-deco-suite-marylebone':
    'Beautifully restored Art Deco suite in the heart of Marylebone village.',
  'docklands-executive-apartment':
    'Spacious executive apartment with dock views, ideal for extended stays.',
  'chelsea-garden-apartment':
    'Elegant garden-level apartment in prestigious Chelsea with private courtyard.',
  'clerkenwell-warehouse-conversion':
    'Spectacular warehouse conversion with double-height ceilings in trendy Clerkenwell.',
  'hampstead-heath-retreat': 'Peaceful retreat near Hampstead Heath, perfect for nature lovers.',
  'brixton-creative-studio':
    'Vibrant studio in multicultural Brixton with excellent transport links.',
  'tower-bridge-luxury-flat':
    'Luxury flat with iconic Tower Bridge views and premium finishes throughout.'
};

export function getPropertyById(id: string): PropertyData | null {
